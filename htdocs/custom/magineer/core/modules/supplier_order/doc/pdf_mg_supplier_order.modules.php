...
/**
 *	\file       htdocs/core/modules/supplier_order/doc/pdf_mg_supplier_order.modules.php
 *	\ingroup    fournisseur
 *	\brief      File of class to generate suppliers orders from mg_supplier_order model
 */
...
/**
 *	Class to generate the supplier orders with the mg_supplier_order model
 */
class pdf_mg_supplier_order extends ModelePDFSuppliersOrders
{
	/**
	...
	protected function _pagefoot(&$pdf, $object, $outputlangs, $hidefreetext = 0)
	{
		...
		return pdf_pagefoot($pdf, $outputlangs, 'SUPPLIER_ORDER_FREE_TEXT', $emetteur, $this->marge_basse, $this->marge_gauche, $this->page_hauteur, $object, $showdetails, $hidefreetext);
	}
