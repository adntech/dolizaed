...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_mgdevis.modules.php
 *	\ingroup    propale
 *	\brief      File of Class to generate PDF proposal with mgdevis template
 */
...
/**
 *	Class to generate PDF proposal mgdevis
 */
class pdf_mgdevis extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "mgdevis";
		$this->description = $langs->trans('DocModelmgdevisDescription');
	...
	protected function _pagefoot(&$pdf, $object, $outputlangs, $hidefreetext = 0)
	{
		...
		return pdf_pagefoot($pdf, $outputlangs, 'PROPOSAL_FREE_TEXT', $emetteur, $this->marge_basse, $this->marge_gauche, $this->page_hauteur, $object, $showdetails, $hidefreetext, $this->page_largeur, $this->watermark);
	}
