...
/**
 * \file    test/phpunit/MagineerFunctionalTest.php
 * \ingroup magineer
 ...
 *
 * @package Testmagineer
 */
class MagineerFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/magineer/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('magineer/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/magineer/admin/about.php');
		$this->authenticate();
		return $this->assertContains('magineer/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('magineerwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMagineer_MagineerTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMagineer_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
