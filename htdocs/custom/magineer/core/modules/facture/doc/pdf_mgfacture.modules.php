...
/**
 *  \file       htdocs/core/modules/facture/doc/pdf_mgfacture.modules.php
 *  \ingroup    facture
 *  \brief      File of class to generate customers invoices from mgfacture model
 */
...
/**
 *	Class to manage PDF invoice template mgfacture
 */
class pdf_mgfacture extends ModelePDFFactures
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "mgfacture";
		$this->description = $langs->trans('PDFmgfactureDescription');
	...
	protected function _pagefoot(&$pdf, $object, $outputlangs, $hidefreetext = 0, $heightforqrinvoice = 0)
	{
		...
		return pdf_pagefoot($pdf, $outputlangs, 'INVOICE_FREE_TEXT', $emetteur, $heightforqrinvoice + $this->marge_basse, $this->marge_gauche, $this->page_hauteur, $object, $showdetails, $hidefreetext, $this->page_largeur, $this->watermark);
	}
